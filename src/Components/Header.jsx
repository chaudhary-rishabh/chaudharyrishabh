...
const Header = () => {
    return (
        <div className='header'>
            ...
            <a href="https://drive.google.com/file/d/1efpjfuL0jzaANv0Lmdk2LEY2t03ibCLV/view?usp=drive_link"><FontAwesomeIcon className='header-icon' style={{ color: "#375168" }} icon={faFilePdf} /></a>
