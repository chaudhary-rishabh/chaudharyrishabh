...
const Header = () => {
    return (
        <div className='header'>
            <a href="https://github.com/chaudhary-rishabh"><FontAwesomeIcon className='header-icon' style={{ color: "#211F1F" }} icon={faGithub} /></a>
            ...
            <a href="mailto:me@chaudharyrishabh.com"><FontAwesomeIcon className='header-icon' style={{ color: "#000000" }} icon={faEnvelope} /></a>
